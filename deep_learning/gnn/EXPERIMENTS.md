...
| 9 | Expanded anchors (755: min-freq-10 words + 114 genre phrases, ModernBERT-init via shared projection) + learned coverage steering | 26,150 pairs | **42.8%** (ndcg@10 0.226) | New best, still climbing at epoch 12. "synth pop"→genre:synth-pop anchors as one unit; "morning"/"synth" now anchor. Greedy "chill christmas morning synth pop" fixed WITHOUT logit adjustment (steering+anchors route). Unmet intents 0.0% |
